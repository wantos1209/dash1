...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" data-color="danger">
  ...
  <?php if(session('jenisdashboard') == 'APP') { ?>
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <div class="col-md-12 d-flex justify-content-center">
      <div class="col-md-10">
        <?php
          ...
          $path = basename($path);  
          // dd(session('id_bo'));
          // dd(request('bo') != '' && request('bo') != session('id_bo'));
        ...
        <form id="formbo" action="{{ $path }}">
          <select class="form-select" name="bo" id="bo" onchange="document.getElementById('formbo').submit();">
            <!-- <option value = "100">Pilih BO</option> -->
            @foreach(getDataBo() as $d)
              <option value="{{ $d->id }}" {{ session('id_bo') == $d->id ? 'selected' : '' }}>{{ strtoupper($d->nama) }}</option>
            @endforeach
          </select>
        </form>
      </div>
    ...
    @if(session('id_bo') != '')
      ...
      <li class="nav-item">
        <a class="nav-link {{ ($menu == 'notifikasi') ? 'active' : '' }}" href="/notifikasi">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ ($menu == 'contact') ? 'active' : '' }}" href="/contact">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1 text-white">CONTACT</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ ($menu == 'link') ? 'active' : '' }}" href="/link">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1 text-white">LINK</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ ($menu == 'setting') ? 'active' : '' }}" href="/setting">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      @can('admin')
        ...
        <li class="nav-item">
          <a class="nav-link {{ ($menu == 'berita') ? 'active' : '' }}" href="/berita">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 text-white">BERITA</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ ($menu == 'pemberitahuan') ? 'active' : '' }}" href="/pemberitahuan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1 text-white">PEMBERITAHUAN</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ ($menu == 'bo') ? 'active' : '' }}" href="/bo">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 text-white">BO</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ ($menu == 'user') ? 'active' : '' }}" href="/user">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="sidenav-footer mx-3 ">
    ...
    <!-- <div class="text-center m-0">
      <a href="javascript:;" class="nav-link text-body font-weight-bold px-0 ">
        <i class="fa fa-user me-sm-1 text-white" aria-hidden="true"></i>
        <span class="d-sm-inline d-none shadow badge badge-sm bg-gradient-danger">{{ auth()->user()->username }}</span>
      </a>
    </div> -->
    <div class="text-center">
      <a class="btn bg-danger mt-3 w-80 text-white" href="{{ route('logout') }}">Logout</a>
    </div>
  </div>
</aside>